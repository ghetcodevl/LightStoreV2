...
<html lang="vi">
    ...
    <!--                                        <button class="delete-btn" onclick="confirmDelete(${p.id})">🗑️ Xóa</button>-->
        ...
        function confirmLogout(event) {
            event.preventDefault(); if (confirm('Đăng xuất?'))
        ...
        function openAddModal() {
            ...
            document.getElementById('productForm').action = '${pageContext.request.contextPath}/admin/products';
        }
        function openEditModal(id, name, price, image, desc, tag, cid) {
            ...
            document.getElementById('productCategory').value = cid;
            document.getElementById('productModal').style.display = 'block';
            document.getElementById('productForm').action = '${pageContext.request.contextPath}/admin/products';
        }
